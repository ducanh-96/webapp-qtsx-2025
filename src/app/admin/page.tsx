            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="hidden md:block">
                  ...
                  <p className="text-xs text-error-600 font-medium">{user?.role}</p>
                </div>
              </div>
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            <div className="bg-gradient-to-r from-error-500 to-error-600 rounded-lg p-6 text-white">
              ...
              <p className="text-error-100">
                Manage users, configure system settings, and monitor application health.
              </p>
            ...
            <div className="card">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-success-600">Online</p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-success-600">Active</p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-primary-600">85% Used</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="border-b border-gray-200">
              <nav className="-mb-px flex space-x-8 px-6">
                <button className="py-4 px-1 border-b-2 border-error-500 font-medium text-sm text-error-600">
                  User Management
                </button>
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">User invitation sent</p>
            ...
            <div className="card">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Phase 2 Progress</h3>
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between text-sm font-medium text-gray-900 mb-1">
                    <span>Sprint 4.1: File Management</span>
                    <span>10%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
